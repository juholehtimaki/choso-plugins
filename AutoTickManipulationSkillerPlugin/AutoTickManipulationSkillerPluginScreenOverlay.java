...
public class AutoTickManipulationSkillerPluginScreenOverlay extends OverlayPanel {
    AutoTickManipulationSkillerPlugin plugin;
    Client client;
    ModelOutlineRenderer modelOutlineRenderer;

    @Inject
    AutoTickManipulationSkillerPluginScreenOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, AutoTickManipulationSkillerPlugin plugin) {
        this.plugin = plugin;
        this.client = client;
