...
public class ScurriusPluginSceneOverlay extends Overlay {
    ...
    @Inject
    ScurriusPluginSceneOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, ScurriusPlugin plugin, ScurriusPluginConfig config) {
        this.plugin = plugin;
        this.client = client;
        this.config = config;
