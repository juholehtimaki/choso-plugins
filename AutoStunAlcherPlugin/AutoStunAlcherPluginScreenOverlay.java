...
public class AutoStunAlcherPluginScreenOverlay extends OverlayPanel {
    AutoStunAlcherPlugin plugin;
    Client client;
    ModelOutlineRenderer modelOutlineRenderer;

    @Inject
    AutoStunAlcherPluginScreenOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, AutoStunAlcherPlugin plugin) {
        this.plugin = plugin;
        this.client = client;
