...
public class ColosseumFarmerPluginScreenOverlay extends OverlayPanel {
    ColosseumFarmerPlugin plugin;
    Client client;
    ModelOutlineRenderer modelOutlineRenderer;

    @Inject
    ColosseumFarmerPluginScreenOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, ColosseumFarmerPlugin plugin) {
        this.plugin = plugin;
        this.client = client;
