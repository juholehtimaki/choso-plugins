...
public class VardorvisPluginScreenOverlay extends OverlayPanel {
    VardorvisPlugin plugin;
    Client client;
    ModelOutlineRenderer modelOutlineRenderer;

    @Inject
    VardorvisPluginScreenOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, VardorvisPlugin plugin) {
        this.plugin = plugin;
        this.client = client;
