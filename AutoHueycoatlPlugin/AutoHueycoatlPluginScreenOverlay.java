...
public class AutoHueycoatlPluginScreenOverlay extends OverlayPanel {
    AutoHueycoatlPlugin plugin;
    Client client;
    ModelOutlineRenderer modelOutlineRenderer;

    @Inject
    AutoHueycoatlPluginScreenOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer, AutoHueycoatlPlugin plugin) {
        this.plugin = plugin;
        this.client = client;
